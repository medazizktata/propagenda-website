...
export const legacyRedirects: Redirect[] = [
  ...
  ...redirect('/graphics-production', '/services/online-offline-marketing'),
  ...redirect('/services/graphics-production', '/services/online-offline-marketing'),
  ...
  ...redirect('/category/branding', '/'),
  ...redirect('/category/websites', '/'),
